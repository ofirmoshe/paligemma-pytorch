...
class PaliGemmaConfig:
    ...
    vision_config: Optional[Dict[str, Any]] = field(default=None)
    text_config: Optional[Dict[str, Any]] = field(default=None)
...
class PaliGemmaForConditionalGeneration(nn.Module):
    ...
    def _merge_input_ids_with_image_features(
        ...
        final_embedding[input_ids == self.config.image_token_index,:] = image_features
